...
try {
    ...
    if ($row2 = $res2 -> fetch_assoc()) {
        ...
        $message = "This mail is regarding the account verification you created at the Creatives.<br>Click the link below to verify your account.<br><br>Click <a href='localhost/Bhumi-Creatives/verify.php?uid=".$uid.
        "'>here</a>.<br><br><br>If this request was not made by you click <a href='localhost/Bhumi-Creatives/unverify.php?uid=".$uid.
        "'>here</a>.";
        ...
        $mail -> send();
        $q3 = "INSERT INTO ulogin VALUES('".$email.
        "','".$hashed.
        "','".$uid.
        "','".$user.
        "','no')";
